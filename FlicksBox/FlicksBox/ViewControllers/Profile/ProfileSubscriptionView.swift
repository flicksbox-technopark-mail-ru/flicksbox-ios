...
//                request.httpBody = "receiver=4100115989236353&label=14&quickpay-form=donate&targets=Подписка FLICKSBOX&sum=3&need-fio=false&need-email=true&need-phone=true&need-address=false&successURL=https://www.flicksbox.ru/profile".data(using: .utf8)
//
